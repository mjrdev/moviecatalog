  ...
  <div class="container my-4">
    <form method="post" action="#">
      <div class="mb-3">
        ...
        <input value="" name="title" type="text" class="form-control" id="movie-name" placeholder="A arca de nóe">
      </div>
      <div class="mb-3">
        <label for="description" class="form-label">Descrição da obra</label>
        <textarea value="" name="description" class="form-control" id="description" rows="3" placeholder="Sinopse do filme aqui..."></textarea>
      </div>
      <div class="mb-3">
        <label for="url-image" class="form-label">URL da Imagem</label>
        <input value="" name="url_image" type="text" class="form-control" id="url-image" placeholder="http://image-url.jpg">
      </div>
